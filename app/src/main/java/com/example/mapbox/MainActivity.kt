...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, OnMapClickListener, PermissionsListener {
    ...
    private fun addDestinationIconSymbolLayer(loadedMapStyle: Style) {
        ...
        loadedMapStyle.addImage("destination-icon-id",
                BitmapFactory.decodeResource(this.resources, com.example.mapbox.R.drawable.map_default_map_marker))
